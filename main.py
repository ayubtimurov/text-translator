...
/start - Start the bot
/about - About the bot
/ui_language - Set bot language
/set_language - Select language to translate to
"""
...
def main():
    ...
    app.add_handler(CallbackQueryHandler(ui_language_callback))
